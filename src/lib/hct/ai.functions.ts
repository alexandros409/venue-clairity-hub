    ...
    const stepsInstruction = (() => {
      if (obsType === "positive") {
        return [
          ...
          "ΑΠΑΓΟΡΕΥΕΤΑΙ ΑΥΣΤΗΡΑ κάθε γενική/template φράση. ΜΗΝ γράψεις ποτέ φράσεις όπως «Καταγράψτε αναλυτικά τα βήματα», «Επιβραβεύστε δημόσια», «Χρησιμοποιήστε ως case study», «στο επόμενο pre-shift briefing», ή οποιαδήποτε γενική διατύπωση που θα ταίριαζε σε ΟΠΟΙΑΔΗΠΟΤ�ε άλλη θετική παρατήρηση.",
