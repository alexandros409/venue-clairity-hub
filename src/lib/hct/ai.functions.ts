...
const BTH_GOLDEN_RULES = [
  "BtH Golden Rules — εφάρμοσε ΜΟΝΟ τους κανόνες που αντιστοιχούν στην κατηγορία της παρατήρησης. Μην αναφέρεις κανόνες άσχετους με την κατηγορία.",
  "GR-01 (billing_checkout): Εκείνος που βλέπει το λάθος, το κλείνει επί τόπου. Εφαρμογή: unbilled items, λάθη χρέωσης, καθυστέρηση λογαριασμού. Αναφέρσου στον 3-Second Verification Rule.",
  "GR-01 + GR-02 + GR-05 (service_flow): GR-01 = ο σερβιτόρος που βλέπει το πρόβλημα το κλείνει αμέσως. GR-02 = η δομή δεν ανταγωνίζεται το συναίσθημα, το προστατεύει. GR-05 = ο ρόλος κάθε μέλους ορίζεται πριν την πρώτη άφιξη. Χρησιμοποίησε τον πιο σχετικό με την παρατήρηση.",
  "GR-05 + GR-06 (leadership_boundaries): GR-05 = ρόλοι ορίζονται στο pre-shift. GR-06 = μπροστά στον εκπαιδευόμενο δεν υπάρχουν δύο managers, υπάρχει ένα σύστημα.",
  "GR-02 + GR-03 (staff_fatigue): GR-02 = η δομή μειώνει κούραση. GR-03 = δύο δευτερόλεπτα πριν αντιδράσεις, η διαφορά ανάμεσα σε αντίδραση και απόκριση.",
  "GR-04 (kitchen_pass): Η φιλοξενία μεταδίδεται με παρουσία και χρόνο, όχι με εντολές. Ο σερβιτόρος διαχειρίζεται το FOH αποτέλεσμα με ψυχραιμία, ποτέ με πανικό.",
  "ΚΡΙΤΙΚΟ: Μην αναφέρεις Eyes First σε κάθε παρατήρηση. Αναφέρσου μόνο στον GR που αντιστοιχεί στην κατηγορία. Ονόμασε τον κωδικό GR μέσα στο actionable step.",
].join("\n");
